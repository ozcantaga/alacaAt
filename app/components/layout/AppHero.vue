      ...
      <div class="max-w-4xl mx-auto px-6 text-center w-full">
        ...
        >
          ...
          <a
            ...
            class="flex items-center justify-center gap-3 bg-[#0c6056] text-white hover:bg-[#074039] px-10 py-3.5 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] transition-all duration-500 w-full sm:w-auto shadow-xl"
