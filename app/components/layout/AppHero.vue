  ...
  >
    ...
    <div class="absolute inset-0 z-0">
      <Transition name="fade" mode="out-in">
        <!-- İlk resim: native img ile anında yükleme (Nuxt Image gecikmesi yok) -->
        <img
          ...
          decoding="async"
        />
        <!-- Sonraki resimler: NuxtImg ile optimize -->
        <NuxtImg
          v-else
      ...
      <div class="max-w-4xl mx-auto px-6 text-center w-full">
        ...
        >
          ...
          <a
            ...
            class="flex items-center justify-center gap-3 bg-[#25D366] text-white hover:bg-[#128C7E] px-10 py-3.5 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] transition-all duration-500 w-full sm:w-auto shadow-xl"
